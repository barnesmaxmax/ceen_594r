...
sedata[c(1200,3300,4500,5500,6000,7500,8000,8500),1:9]
```
...
```{r}
include_graphics(rep('images/model_framework.png', 3))
```
...
```{r}
include_graphics(rep('images/absolute_error_choropleth', 3))
```
...
```{r}
include_graphics(rep('images/risky_links.png', 3))
```
